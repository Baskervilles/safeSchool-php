...
class NoteController extends Controller
{
    ...
    public function newAction(Request $request)
    {
      ...
      $noteHelper = $request->get('noteHelper');
      $helperOne = $noteHelper->getNoteHelperInfoOne();
      $helperTwos = $noteHelper->getNoteHelperInfoTwos();

      $ets_apprenant = $em->getRepository('AppBundle:EtablissementApprenant')->findByApprenant($helperOne->getId());
